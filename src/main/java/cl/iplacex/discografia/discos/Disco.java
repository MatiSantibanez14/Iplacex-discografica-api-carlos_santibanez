...
public class Disco {
    ...
    public boolean equals(Object o) {
        ...
        Disco disco = (Disco) o;
        return anioLanzamiento == disco.anioLanzamiento &&
                Objects.equals(id, disco.id) &&
                Objects.equals(idArtista, disco.idArtista) &&
                Objects.equals(nombre, disco.nombre) &&
                Objects.equals(canciones, disco.canciones);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, idArtista, nombre, anioLanzamiento, canciones);
    }
